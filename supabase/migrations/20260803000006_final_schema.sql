...
drop table if exists public.pricing_cards cascade;
drop table if exists public.patch_cards cascade;
...
drop table if exists public.sew_outs cascade;
drop table if exists public.hero_slides cascade;
drop table if exists public.digitizers cascade;
...
-- ============================================================
-- B Digitizing & Vector Studio — Catalog Seed Data
-- Populates site catalog content (services, pricing, store, portfolio).
-- No transactional/fake data (orders/clients) is seeded here.
