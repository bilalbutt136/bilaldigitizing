...
\restrict tcSXyyNXtVrgZ1dPklEYYfabedgEcpwLaqsenAK6D0Q9dVdvbt8IcW5LPWXw4Lf
...
--
-- Name: clients Allow public read/write on clients; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Allow public read/write on clients" ON public.clients USING (true) WITH CHECK (true);


--
-- Name: order_files Allow public read/write on order_files; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Allow public read/write on order_files" ON public.order_files USING (true) WITH CHECK (true);


--
-- Name: orders Allow public read/write on orders; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Allow public read/write on orders" ON public.orders USING (true) WITH CHECK (true);


--
-- Name: revisions Allow public read/write on revisions; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Allow public read/write on revisions" ON public.revisions USING (true) WITH CHECK (true);


--
-- Name: transactions Allow public read/write on transactions; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Allow public read/write on transactions" ON public.transactions USING (true) WITH CHECK (true);
...
--
-- Name: objects Public Read/Write Client Uploads; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Public Read/Write Client Uploads" ON storage.objects USING ((bucket_id = 'client-uploads'::text)) WITH CHECK ((bucket_id = 'client-uploads'::text));


--
-- Name: objects Public Read/Write Finished Packages; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Public Read/Write Finished Packages" ON storage.objects USING ((bucket_id = 'finished-packages'::text)) WITH CHECK ((bucket_id = 'finished-packages'::text));
...
\unrestrict tcSXyyNXtVrgZ1dPklEYYfabedgEcpwLaqsenAK6D0Q9dVdvbt8IcW5LPWXw4Lf
