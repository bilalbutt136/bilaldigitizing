...
\restrict whxrd7E9MEjrLlmowpTEDKwtnqys2faIVFZmBdYako0tpS9mCh0BhdJmVhit30T
...
--
-- Name: objects Public Access to Portfolio Images; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Public Access to Portfolio Images" ON storage.objects FOR SELECT USING ((bucket_id = 'portfolio-images'::text));
...
--
-- Name: objects storage_admin_all; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY storage_admin_all ON storage.objects USING (public.is_admin()) WITH CHECK (public.is_admin());


--
-- Name: objects storage_client_uploads_read; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY storage_client_uploads_read ON storage.objects FOR SELECT USING (((bucket_id = 'client-uploads'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects storage_client_uploads_write; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY storage_client_uploads_write ON storage.objects FOR INSERT WITH CHECK (((bucket_id = 'client-uploads'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects storage_finished_packages_admin; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY storage_finished_packages_admin ON storage.objects USING (((bucket_id = 'finished-packages'::text) AND public.is_admin())) WITH CHECK (((bucket_id = 'finished-packages'::text) AND public.is_admin()));


--
-- Name: objects storage_finished_packages_read; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY storage_finished_packages_read ON storage.objects FOR SELECT USING (((bucket_id = 'finished-packages'::text) AND (auth.role() = 'authenticated'::text)));
...
\unrestrict whxrd7E9MEjrLlmowpTEDKwtnqys2faIVFZmBdYako0tpS9mCh0BhdJmVhit30T
