      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{ fontSize: '0.85rem', color: '#94a3b8' }}>
            Enter your new secure password to restore access to your digitizer workstation
          </p>
        </div>
        ...
        {isSuccess ? (
          <div style={{ textAlign: 'center' }}>
            <div style={{
              ...
              Your workstation credentials have been securely updated. Redirecting to digitizer login...
            </div>
