...
export default function PortalForgotPasswordPage() {
  ...
  const handleResetRequest = async (e) => {
    ...
    if (!cleanEmail) {
      setErrorMessage('Please enter your workstation account email address.');
      return;
    }
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{ fontSize: '0.85rem', color: '#94a3b8' }}>
            Enter your registered workstation email address to receive a secure recovery link
          </p>
        </div>
        ...
        {isSuccess ? (
          <div style={{ textAlign: 'center' }}>
            <div style={{
              ...
              We have sent a secure password recovery link to <strong style={{ color: '#ffffff' }}>{email}</strong>. Please check your inbox and spam folders.
            </div>
            ...
            >
              <ArrowLeft size={16} /> Return to Task Portal Login
            </Link>
          </div>
        ) : (
          <>
            ...
            <div style={{ marginTop: '1.75rem', paddingTop: '1.25rem', borderTop: '1px solid #1f293d', textAlign: 'center' }}>
              <Link
                href="/portal/login"
                style={{
                  color: '#94a3b8',
