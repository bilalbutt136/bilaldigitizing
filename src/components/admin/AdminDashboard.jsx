          ...
          <div style={{ display: 'flex', gap: '0.65rem', alignItems: 'center' }}>
            ...
            <button
              ...
              style={{
                ...
                alignItems: 'center',
                gap: '0.45rem',
                background: activeTab === 'chat' ? '#fff7ed' : '#ffffff',
                border: activeTab === 'chat' ? '1.5px solid #ff7a00' : '1.5px solid var(--border-color)',
                color: activeTab === 'chat' ? '#ff7a00' : 'var(--navy-900)',
                padding: '0.6rem 1rem',
                borderRadius: 'var(--radius-md)',
                fontWeight: 800,
                fontSize: '0.875rem',
              ...
              onMouseOut={(e) => { if (activeTab !== 'chat') { e.currentTarget.style.borderColor = 'var(--border-color)'; e.currentTarget.style.color = 'var(--navy-900)'; } }}
            >
              ...
              {isHeaderNotificationOpen && (
                <div style={{
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem', paddingBottom: '0.5rem', borderBottom: '1px solid var(--border-color)' }}>
                    <span style={{ fontWeight: 800, fontSize: '0.9rem', color: 'var(--navy-900)' }}>Operations Alerts</span>
                    <button
                      type="button"
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.55rem' }}>
                    <div style={{ padding: '0.65rem', borderRadius: '8px', background: '#fff7ed', border: '1px solid rgba(255, 122, 0, 0.2)', fontSize: '0.8rem' }}>
                      <div style={{ fontWeight: 800, color: 'var(--navy-900)' }}>⚡ New Order Submitted (#DIG-9912)</div>
                      <div style={{ color: 'var(--text-muted)', fontSize: '0.75rem' }}>Client requested 8-hr express turnaround for Left Chest logo.</div>
                    </div>
                    <div style={{ padding: '0.65rem', borderRadius: '8px', background: '#f8fafc', border: '1px solid var(--border-color)', fontSize: '0.8rem' }}>
                      <div style={{ fontWeight: 800, color: 'var(--navy-900)' }}>💳 Wallet Deposit Received</div>
                      <div style={{ color: 'var(--text-muted)', fontSize: '0.75rem' }}>Apex Apparel added $250.00 studio wallet credit.</div>
                    </div>
                    <div style={{ padding: '0.65rem', borderRadius: '8px', background: '#f8fafc', border: '1px solid var(--border-color)', fontSize: '0.8rem' }}>
                      <div style={{ fontWeight: 800, color: 'var(--navy-900)' }}>💬 Unread Client Message</div>
                      <div style={{ color: 'var(--text-muted)', fontSize: '0.75rem' }}>Sarah Jenkins sent a inquiry regarding 3D Puff thread colors.</div>
                    </div>
                  </div>
                </div>
              )}
