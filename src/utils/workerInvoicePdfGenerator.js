...
export async function generateWorkerPayoutInvoicePdf({
  ...
  doc.text(stealthMode ? 'Production Billing & Operations Desk' : 'Lahore, Pakistan • support@bdigitizing.com • www.bdigitizing.com', 14, 33);
  ...
  doc.text(stealthMode ? '3. Authorized by Production Operations Desk.' : '3. Authorized by BDigitizing Studio Management Desk.', 14, finalY + 20);
  ...
  doc.text(stealthMode ? 'Digitizing Task Portal — Production Operations Desk' : 'BDigitizing — Pakistan Production Operations Desk', 210 - 14, 285, { align: 'right' });
