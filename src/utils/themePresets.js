  ...
  },
  {
    ...
    tokens: {
      ...
      dark: {
        ...
        '--banner-border': 'rgba(56, 189, 248, 0.28)',
        '--stats-bar-bg': '#070f1a',
        ...
        '--cta-badge-bg': 'rgba(56, 189, 248, 0.15)',
  ...
  },
  {
    ...
    tokens: {
      ...
      dark: {
        ...
        '--color-primary-glow': 'rgba(129, 140, 248, 0.40)',
        '--color-primary-text': '#ffffff',
        ...
        '--color-input': '#18183d',
        '--color-border': 'rgba(255, 255, 255, 0.16)',
        '--color-border-hover': 'rgba(129, 140, 248, 0.35)',
        '--color-border-focus': '#818cf8',
        '--color-text-primary': '#ffffff',
        '--color-text-secondary': '#e2e8f0',
        '--color-text-muted': '#94a3b8',
        '--color-text-on-primary': '#ffffff',
        '--hero-bg': 'radial-gradient(ellipse 90% 60% at 50% -10%, rgba(129, 140, 248, 0.15) 0%, rgba(67, 56, 202, 0.4) 50%, transparent 80%), linear-gradient(180deg, #09091b 0%, #11112b 100%)',
        '--hero-card-bg': '#11112b',
        '--hero-card-border': 'rgba(255, 255, 255, 0.16)',
        '--hero-card-shadow': '0 20px 50px -15px rgba(0, 0, 0, 0.7)',
        '--banner-bg': 'linear-gradient(135deg, #11112b 0%, #1a1a3e 50%, #09091b 100%)',
        '--banner-border': 'rgba(129, 140, 248, 0.28)',
        '--stats-bar-bg': '#09091b',
        '--stats-card-bg': '#11112b',
        '--stats-card-border': 'rgba(255, 255, 255, 0.14)',
        '--stats-number-color': '#ffffff',
        '--stats-label-color': '#94a3b8',
        '--cta-bg': 'radial-gradient(ellipse 90% 70% at 50% 0%, rgba(129, 140, 248, 0.15) 0%, rgba(67, 56, 202, 0.3) 50%, transparent 80%), linear-gradient(180deg, #09091b 0%, #11112b 100%)',
        '--cta-badge-bg': 'rgba(129, 140, 248, 0.15)',
  ...
  },
  {
    ...
    tokens: {
      ...
      dark: {
        ...
        '--color-primary-light': 'rgba(52, 211, 153, 0.18)',
        '--color-primary-glow': 'rgba(52, 211, 153, 0.40)',
        '--color-primary-text': '#ffffff',
        ...
        '--color-text-muted': '#94a3b8',
        '--color-text-on-primary': '#ffffff',
        '--hero-bg': 'radial-gradient(ellipse 90% 60% at 50% -10%, rgba(52, 211, 153, 0.15) 0%, rgba(6, 95, 70, 0.4) 50%, transparent 80%), linear-gradient(180deg, #041611 0%, #0a261f 100%)',
        '--hero-card-bg': '#0a261f',
        '--hero-card-border': 'rgba(255, 255, 255, 0.16)',
        '--hero-card-shadow': '0 20px 50px -15px rgba(0, 0, 0, 0.7)',
        '--banner-bg': 'linear-gradient(135deg, #0a261f 0%, #0f382e 50%, #041611 100%)',
        '--banner-border': 'rgba(52, 211, 153, 0.28)',
        '--stats-bar-bg': '#041611',
        ...
        '--cta-badge-bg': 'rgba(52, 211, 153, 0.15)',
  ...
  },
  {
    ...
    tokens: {
      ...
      dark: {
        ...
        '--cta-badge-bg': 'rgba(255, 255, 255, 0.1)',
        '--cta-badge-border': 'rgba(255, 255, 255, 0.3)',
