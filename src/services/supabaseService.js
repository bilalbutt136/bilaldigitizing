  ...
  try {
    ...
    return orders.map(order => {
      ...
      return {
        ...
        worker_payout: parseFloat(order.worker_payout) || 0,
        workerPayout: parseFloat(order.worker_payout) || 0,
        worker_payout_status: order.worker_payout_status || 'unpaid',
        workerPayoutStatus: order.worker_payout_status || 'unpaid',
